...
export default eventHandler(() => {
  return `
    ...
    <body class="bg-[#0c0c0c] overflow-hidden text-gray-800 min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <footer class="mt-10 text-center text-gray-500 text-sm">
        <p class="flex justify-center items-center space-x-2 mt-2">
          <a href="https://github.com/sussy-code/wyzie-subs" rel="nofollow" target="_blank" rel="noopener noreferrer" class="hover:text-primary-400 text-dark" >
          ...
          <a href="https://sudo-flix.lol/" rel="nofollow" class="hover:text-primary-400 text-dark">
           ...
           <a href="https://twitter.com/SudoFlix" rel="nofollow" class="hover:text-primary-400 text-dark">
          ...
          <a href="https://discord.gg/r5cYshWM4G" class="hover:text-primary-400 text-dark">
        ...
        <p class="mt-2 text-dark">Created by BadDeveloper and AbdullahDaGoat</p>
      </footer>
    </body>
    </html>
  `;
